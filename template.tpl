...

{
  ...
  "description": "A server-side tag template that reconfigures the data sent from your GA4 event tags that is claimed by the GA4 client in server-side, and then posted to Segment the Tracking Pixel API source.",
  "containerContexts": [
    "SERVER"
  ]
}
